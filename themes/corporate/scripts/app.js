var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "themes/corporate/css/themes/" + color + (isRTL ? '-rtl' : '') + ".css");
            $('#logoimg').attr("src", "themes/corporate/img/logo_" + color + ".png");
            $('#rev-hint1').attr("src", "themes/corporate/img/sliders/revolution/hint1-" + color + ".png");
            $('#rev-hint2').attr("src", "themes/corporate/img/sliders/revolution/hint2-" + color + ".png");
        }
