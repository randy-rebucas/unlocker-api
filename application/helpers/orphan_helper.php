...
function delete_orphans()
{
    ...
    $queries = array(
        'DELETE FROM fi_invoices WHERE patient_id NOT IN (SELECT patient_id FROM fi_patients)',
        'DELETE FROM fi_quotes WHERE patient_id NOT IN (SELECT patient_id FROM fi_patients)',
        ...
        'DELETE FROM fi_patient_custom WHERE patient_id NOT IN (SELECT patient_id FROM fi_patients)',
        ...
        'DELETE FROM fi_patient_notes WHERE patient_id NOT IN (SELECT patient_id FROM fi_patients)'
    );
