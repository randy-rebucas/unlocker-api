...
$lang['notification_subject_order_status'] = 'Order status from %s.';
$lang['notification_subject_funds'] = 'Funds added from %s.';
$lang['notification_subject_updates'] = '%s new updates!';
